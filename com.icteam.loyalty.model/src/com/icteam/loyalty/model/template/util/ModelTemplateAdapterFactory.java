 ...
 * @generated
 */
public class ModelTemplateAdapterFactory extends AdapterFactoryImpl {
    /**
     ...
     * @generated
     */
    public ModelTemplateAdapterFactory() {
     ...
     * @generated
     */
    protected ModelTemplateSwitch<Adapter> modelSwitch = new ModelTemplateSwitch<Adapter>() {
            @Override
            public <T extends Serializable> Adapter caseAbstractEMFTemplate(AbstractEMFTemplate<T> object) {
                return createAbstractEMFTemplateAdapter();
            }
            @Override
            public Adapter caseDictionaryEMFTemplate(DictionaryEMFTemplate object) {
                return createDictionaryEMFTemplateAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.icteam.loyalty.model.template.AbstractEMFTemplate <em>Abstract EMF Template</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createAbstractEMFTemplateAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.icteam.loyalty.model.template.DictionaryEMFTemplate <em>Dictionary EMF Template</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createDictionaryEMFTemplateAdapter() {
        return null;
    }
