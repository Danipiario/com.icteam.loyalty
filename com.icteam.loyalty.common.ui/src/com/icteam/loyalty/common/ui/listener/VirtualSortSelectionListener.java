...
//
// public class VirtualSortSelectionListener<T extends AbstractTemplate< ? >, D
// extends IDtoModel> extends DefaultSortSelectionListener {
//
...
//
// public VirtualSortSelectionListener(IVirtualView<T, D> virtualView, Class< ?
// extends Object> beanClass, String propertyName) {
...
// template.setDynamicOrder(propertyName,
// convert(getTable().getSortDirection()));
//
