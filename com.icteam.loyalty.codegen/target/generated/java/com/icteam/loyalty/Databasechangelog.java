...
/**
 * Databasechangelog is a Querydsl query type for Databasechangelog
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class Databasechangelog extends com.querydsl.sql.RelationalPathBase<Databasechangelog> {

    private static final long serialVersionUID = -1650777913;

    public static final Databasechangelog databasechangelog = new Databasechangelog("DATABASECHANGELOG");
    ...
    public Databasechangelog(String variable) {
        super(Databasechangelog.class, forVariable(variable), "LOYALTY", "DATABASECHANGELOG");
        addMetadata();
    }

    public Databasechangelog(String variable, String schema, String table) {
        super(Databasechangelog.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public Databasechangelog(Path<? extends Databasechangelog> path) {
        super(path.getType(), path.getMetadata(), "LOYALTY", "DATABASECHANGELOG");
        addMetadata();
    }

    public Databasechangelog(PathMetadata metadata) {
        super(Databasechangelog.class, metadata, "LOYALTY", "DATABASECHANGELOG");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(orderexecuted, ColumnMetadata.named("ORDEREXECUTED").withIndex(5).ofType(Types.DECIMAL).withSize(0).notNull());
