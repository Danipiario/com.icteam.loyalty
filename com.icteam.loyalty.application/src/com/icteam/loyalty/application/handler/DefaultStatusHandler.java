...
//		final Throwable exception = statusAdapter.getStatus().getException();
//
//		exception.printStackTrace();
//
//		if (exception instanceof AppException) {
//			final AppException e = (AppException) exception;
//			final IStatusReason statusReason = e.getStatusReason();
//
