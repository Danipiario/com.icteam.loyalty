...
import org.eclipse.emf.ecp.view.internal.core.swt.renderer.BooleanControlSWTRenderer;
...
public class BooleanControlRenderer extends BooleanControlSWTRenderer {

    private final AdapterFactoryItemDelegator adapterFactoryItemDelegator;
    private final ComposedAdapterFactory composedAdapterFactory;

    @Inject
    public BooleanControlRenderer(VControl vElement, ViewModelContext viewContext, ReportService reportService, EMFFormsDatabinding emfFormsDatabinding,
    ...
    protected Binding[] createBindings(Control control) throws DatabindingFailedException {
        ...
        if (getViewModelContext().getDomainModel() instanceof IEditable) {
            ...
            bindings.add(getDataBindingContext().bindValue(SWTObservables.observeEnabled(control), changeableObserveValue));
            if (!getVElement().isReadonly()) {
