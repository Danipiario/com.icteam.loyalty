...
import com.icteam.loyalty.ui.dialog.FilterTableEMFDialog;
import com.icteam.loyalty.ui.model.VirtualViewEMFModel;

public class ViewFilterColumnsEMFHandler<T extends AbstractEMFTemplate< ? >, D extends EMFModel> extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) {
        if (event.getTrigger() instanceof Event) {
            ...
            if (e.data instanceof Object[] && ((Object[]) e.data)[0] instanceof VirtualViewEMFModel) {
                ...
                new FilterTableEMFDialog<>(Display.getCurrent().getActiveShell(), virtualViewEMFModel).open();
            }
        }
