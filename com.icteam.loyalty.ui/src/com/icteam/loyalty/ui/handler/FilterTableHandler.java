...
import com.icteam.loyalty.ui.dialog.FilterTableDialog;
import com.icteam.loyalty.ui.interfaces.IVirtualView;

public class FilterTableHandler<T extends AbstractTemplate< ? >, D extends DtoModel> extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event)  {
        ...
        if (workbenchPart instanceof IVirtualView) {
            ...
            new FilterTableDialog<>(Display.getCurrent().getActiveShell(), virtualView).open();
        }
