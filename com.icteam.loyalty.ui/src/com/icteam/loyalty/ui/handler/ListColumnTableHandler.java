...
import com.icteam.loyalty.ui.dialog.ListColumnTableDialog;
import com.icteam.loyalty.ui.interfaces.IVirtualView;

public class ListColumnTableHandler<T extends AbstractTemplate< ? >, D extends DtoModel> extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event)  {
        ...
        if (workbenchPart instanceof IVirtualView) {
            ...
            new ListColumnTableDialog<>(Display.getCurrent().getActiveShell(), virtualView).open();
        }
