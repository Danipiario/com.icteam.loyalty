...
import com.icteam.loyalty.ui.control.CommandControlSWTControlSWTRenderer;
import com.icteam.loyalty.ui.util.UIUtils;

@Component(service = EMFFormsDIRendererService.class)
public class CommandControlRendererService implements EMFFormsDIRendererService<VControl> {

    private EMFFormsDatabinding databindingService;

    @Override
    public Class< ? extends AbstractSWTRenderer<VControl>> getRendererClass() {
        return CommandControlSWTControlSWTRenderer.class;
    }
