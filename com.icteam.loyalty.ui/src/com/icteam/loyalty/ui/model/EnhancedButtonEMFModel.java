...
public class EnhancedButtonEMFModel<M extends EMFModel, S extends Object> {

    private ImageDescriptor image;
    private final String iconPath;

    private static final String PREFIC_ICON_PATH = "/icons/";
    ...
    public EnhancedButtonEMFModel(M model, String action, String iconPath) {
        this(model, model.getPermissionObject() + "_" + action, action, iconPath);
    }

    public EnhancedButtonEMFModel(M model, String commandId, String permissionAction, String iconPath) {
        this.model = model;
        this.commandId = commandId;
        this.permission = model.getPermissionObject() + "_" + permissionAction;
        this.iconPath = PREFIC_ICON_PATH + iconPath;
