...
import com.icteam.loyalty.ui.control.EnhancedEnumComboViewerRenderer;
import com.icteam.loyalty.ui.util.UIUtils;

@Component(service = EMFFormsDIRendererService.class)
public class EnhancedEnumControlRendererService implements EMFFormsDIRendererService<VControl> {

    private EMFFormsDatabinding databindingService;

    @Override
    public Class< ? extends AbstractSWTRenderer<VControl>> getRendererClass() {
        return EnhancedEnumComboViewerRenderer.class;
    }
