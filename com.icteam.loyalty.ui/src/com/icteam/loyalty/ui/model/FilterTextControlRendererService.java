...
import com.icteam.loyalty.ui.control.FilterTextControlRenderer;
import com.icteam.loyalty.ui.util.UIUtils;

@Component(service = EMFFormsDIRendererService.class)
public class FilterTextControlRendererService implements EMFFormsDIRendererService<VControl> {

    private EMFFormsDatabinding databindingService;

    @Override
    public Class< ? extends AbstractSWTRenderer<VControl>> getRendererClass() {
        return FilterTextControlRenderer.class;
    }
    ...
    public double isApplicableForFeature(EStructuralFeature feature, VElement vElement, ViewModelContext context) {
        if ((Boolean) ModelUtil.getAnnotation(feature, EAnnotation.FILTER)) {
            return 10d;
        }
