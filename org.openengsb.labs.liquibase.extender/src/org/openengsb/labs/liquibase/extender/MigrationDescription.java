...
public class MigrationDescription implements Serializable {
    ...
    private final List<MigrationDescriptionElement> elements = new ArrayList<>();
    ...
    public MigrationDescription newElement(String source, String id, String author, Set<String> context, boolean beenRun) {
    ...
    public class MigrationDescriptionElement implements Serializable {
        ...
        private final boolean beenRun;

        MigrationDescriptionElement(String source, String id, String author, Set<String> context, boolean beenRun) {
            this.source = source;
            this.id = id;
            this.author = author;
