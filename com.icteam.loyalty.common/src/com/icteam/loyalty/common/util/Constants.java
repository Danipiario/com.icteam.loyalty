...
public class Constants {
	...
	public static final String BACKGROUND_OPERATOR = "process";
	...
	//
	// String OK = "OK";
	// String ENUM_RETRIEVE_CLASS =
	// "com.icteam.loyalty.core.retrieve.EnumRetrieve";
	// String IDENTITY_RETRIEVE_CLASS =
	// "com.icteam.loyalty.core.retrieve.IdentityRetrieve";
	// String DB_RETRIEVE_CLASS = "com.icteam.loyalty.core.retrieve.DbRetrieve";
	//
	// String DB_PROPERTY_GROUP_CLASS =
	// "com.icteam.loyalty.core.property.DbPropertyGroup";
	// String FILE_PROPERTY_GROUP_CLASS =
	// "com.icteam.loyalty.core.property.FilePropertyGroup";
	//
