...
// try {
// logger.info("bundle #{} - remove DTO #{}", bundle.getSymbolicName(),
// dtoClass);
//
// final Class<? extends IDTO> dtoExtendedClass = (Class<? extends IDTO>)
// bundle.loadClass(dtoClass);
// final Class<? extends IDTO> dc = (Class<? extends IDTO>)
// dtoExtendedClass.getSuperclass();
//
